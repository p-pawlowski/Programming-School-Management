...
<body>
	...
	<div class=container>
		<h1>Zarządzanie zadaniami - usuwanie</h1>



		<form method="POST"
			action="../school/ExcerciseManagementDelete">

			<input type="hidden" name="excercise_id" value=${excerciseId}>
			</p>
			<h2>Czy potwierdzasz usunięcie zadania</h2>
